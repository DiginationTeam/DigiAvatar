...
module.exports = {
  ...
  networks: {
    ...
    live: {
      provider: () => new HDWalletProvider([process.env.WALLET_PRIVATE_KEY], `https://mainnet.infura.io/v3/${process.env.WEB3_INFURA_PROJECT_ID}`, 0, 1),
    ...
    rinkeby: {
      provider: () => new HDWalletProvider([process.env.WALLET_PRIVATE_KEY], `https://rinkeby.infura.io/v3/${process.env.WEB3_INFURA_PROJECT_ID}`, 0, 1),
